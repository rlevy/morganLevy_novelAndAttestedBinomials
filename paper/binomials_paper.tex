...
\hline
\emph{Constraint} & \emph{Regression coefficient} &\emph{Std. Error} & \emph{z value} & \emph{p value} \\\hline    
 Formal Markedness   & 1.39     & 0.56   & 2.49  & 0.01 \\\hline  
Perceptual Markedness   & 1.72     & 0.51  &  3.40 &  0.0007 \\\hline  
 Power &     1.03 &     0.57&    1.81 &  0.07   \\\hline  
Iconic Sequencing  &    18.62\footnotemark &   709.22  &  0.026 &  0.98    \\\hline  
 No Final Stress   &    0.50   &   0.33 &   1.50&   0.13    \\\hline  
 Frequency   &    0.32    &  0.14 &   2.35  & 0.02  \\\hline  
 Length  &    0.43  &    0.21 &   2.07 &  0.04  \\\hline  
\end{tabular}
\caption{Constraint weights in our probabilistic model.}\label{t:weights}
\end{table} 
...
\begin{figure}[t]
\includegraphics[scale=0.6]{just-judge.pdf}
\caption{Results of Experiment 1: Proportion of binomials occuring in alphabetical order in Google n-grams corpus frequency (left) and subjects' forced-choice preference judgments (right). In judgments, attested binomials have more extreme preferences (i.e. more consistent across subjects) than novel binomials, demonstrating a qualitatively similar distribution to corpus frequencies.} \label{fig:judge}
\end{figure}
...
Intercept     &       -0.14 &    0.15  & -0.98& 0.33    \\\hline  
Type: novel       &          0.25   &  0.19 & 1.32 &0.19 \\\hline  
Abs know  (Type: attested)    &   2.32   &  0.56  & 4.12 & .00004^{***} \\\hline  
Abs know (Type: novel)   &1.45 &    0.35  & 4.11 &.00004^{***}    \\\hline  
...
Intercept   &  196.34   &  26.04   & 7.54\\\hline 
Type: novel & 195.17 &    25.77  & 7.57\\\hline 
Abs know (Type: attested)      &   13.88    & 23.14  &  0.60\\\hline 
Abs know (Type: novel) & -48.73 &     18.02 &  -2.70 \\\hline 
Rel freq &  -59.25  &   18.42  & -3.22\\\hline 
